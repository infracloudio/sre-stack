...
- Known debt: `scenarios/scenario-02/scripts/kill-sleep-processes.sh`
  hardcodes an RDS password and endpoint. Tracked for cleanup in
  `intent/aks-migration.md`; the hook flags scripts matching this pattern so
  new instances do not accumulate.
