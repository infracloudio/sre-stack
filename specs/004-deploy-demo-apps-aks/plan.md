...
| **VIII. Try It Before You Plan It** | ✓ | This entire plan is built from live command output against the real AKS cluster (research.md, plus the corrections table above). No claim in this file is asserted without a citation to a real command's output. |
